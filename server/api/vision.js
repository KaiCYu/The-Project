...
exports.spliceReceipt = function(receiptArray) {
  ...
  var checkPricesAddToTotal = function() {
    ...
    if (totalPrice !== accumPrice) {
      itemToPriceObj['<NOTE>'] = 'We apologize for the inconvenience, we may not have accurately parsed your receipt. You can utilize the delete and add items buttons to adjust the results and to remove this note';
    }
  };
